#!/usr/bin/env python3
"""
Generate animated GIF demo of nano-claude SSJ Developer Mode.
...
def build_scenes():
    ...
    topic = "nano-claude SSJ features"
    ...
    add(base_menu + [ssj_prompt("1")] + [
        None,
        [seg("  ── Brainstorm: ", SUBTEXT), seg("nano-claude SSJ features", CYAN), seg(" ──", SUBTEXT)],
        None,
